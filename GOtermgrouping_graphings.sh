...
awk -F '\t' '$8 < 4 && $8>1'  table_GOassociation_F22_SA/sigfdr_table_F22_SA/sig_fdr_table_F22_SA_$clusterSA.txt | sed 's/^[^G]*G/G/' | awk -F '\t' 'BEGIN{OFS="|";}{print $1, $2, $8, $5, $9, $13, $4}' >> comparing_cluster_graphing/GO_sigfdr_table_F22_SA_$clusterSA.txt;
...
awk -F '\t' '$8 < 4 && $8>1'  table_GOassociation_F22_SO/sigfdr_table_F22_SO/sig_fdr_table_F22_SO_$clusterSO.txt | sed 's/^[^G]*G/G/' | awk -F '\t' 'BEGIN{OFS="|";}{print $1, $2, $8, $5, $9, $13, $4}' >> comparing_cluster_graphing/GO_sigfdr_table_F22_SO_$clusterSO.txt
...
awk -F '\t' '$8 < 4 && $8>1'  table_GOassociation_F22_OA/sigfdr_table_F22_OA/sig_fdr_table_F22_OA_$clusterOA.txt | sed 's/^[^G]*G/G/' | awk -F '\t' 'BEGIN{OFS="|";}{print $1, $2, $8, $5, $9, $13, $4}'>> comparing_cluster_graphing/GO_sigfdr_table_F22_OA_$clusterOA.txt;
