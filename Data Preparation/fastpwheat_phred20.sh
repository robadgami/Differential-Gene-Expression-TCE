...
fastp -q 20
 -u 50
-i $inputreads/$sample\_R1_001.fastq.gz -I $inputreads/$sample\_R2_001.fastq.gz -o $work/$sample\_output_R1_001.fastq.gz -O $work/$sample\_output_R2_002.fastq.gz
