...
### F22_1dpi ###
sigF22_tpm_1dpi <- read_excel("~/Desktop/sigF22_tpm_1dpi.xlsx")
View(sigF22_tpm_1dpi)
colnames(sigF22_tpm_1dpi)
...
write.table(sigF22_tpm_1dpi, file=paste0("~/Desktop/sigF22_tpm_1dpi.txt", sep="\t"))
...
View(sigF22_tpm_1dpi_ternary)
colnames(sigF22_tpm_1dpi_ternary)


ternaryplot_F22_1dpi <- ggtern(data=sigF22_tpm_1dpi_ternary,aes(sigF22_tpm_1dpi.percentTPM_OA,sigF22_tpm_1dpi.percentTPM_SA,sigF22_tpm_1dpi.percentTPM_SO)) + geom_point(alpha = 0.8, size =0.005,col="gray") +
...
names(sigF22_TPMlist)[names(sigF22_TPMlist)=="F22-11_SA1"] <- "F22_11_SA1"

rename(sigF22_TPMlist$`F22-11_SA1`, sigF22_TPMlist$F22_11_SA1)
View(sigF22_TPMlist)
...
ternaryplot_F22_3dpi <- ggtern(data=sigF22_tpm_3dpi_ternary,aes(sigF22_tpm_3dpi.percentTPM_OA,sigF22_tpm_3dpi.percentTPM_SA,sigF22_tpm_3dpi.percentTPM_SO)) + geom_point(alpha = 0.8, size =0.005, col="gray") +
...
ternaryplot_F22_11dpi <- ggtern(data=sigF22_tpm_11dpi_ternary,aes(sigF22_tpm_11dpi.percentTPM_OA,sigF22_tpm_11dpi.percentTPM_SA,sigF22_tpm_11dpi.percentTPM_SO)) + geom_point(alpha = 0.8, size =0.005, col="gray") +
