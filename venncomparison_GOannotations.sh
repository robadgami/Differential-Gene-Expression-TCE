...
head -1 GOcomparison_F22_OAnSA_1dpi.txt > refined_GOcomparison_F22_OAnSA_3dpi.txt
while read line; do grep $line GOcomparison_F22_OAnSA_3dpi.txt >> refined_GOcomparison_F22_OAnSA_3dpi.txt; done < interest_3dpi.txt
